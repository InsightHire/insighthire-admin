...
export default function BillingPricingPage() {
  ...
  const planFeatures: Record<string, { included: string[]; excluded: string[] }> = {
    STARTER: {
      included: [
        '50 candidate video screenings per month',
        'Unlimited roles & positions',
        'Video pre-screening questions',
        'Automated scoring & ranking',
        'Standard question templates',
        'Basic analytics dashboard',
        'Email support (48hr response)',
      ],
      excluded: ['Custom screening questions', 'ATS integrations', 'API access', 'White-label branding'],
    },
    PROFESSIONAL: {
      included: [
        '200 candidate video screenings per month',
        'Unlimited roles & positions',
        'Video pre-screening questions',
        'Automated scoring & ranking',
      ...
      excluded: ['White-label branding', 'API access', 'Dedicated success manager'],
    },
    ENTERPRISE: {
      included: [
        'Unlimited candidate video screenings',
        'Unlimited roles & positions',
